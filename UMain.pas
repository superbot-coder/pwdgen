...
begin
  ...
  begin
    ChBoxSpeñialChar.Enabled    := false;
    edCastomSpecialChar.Enabled := true;
  end
  else
  begin
    ChBoxSpeñialChar.Enabled    := true;
...
begin
  ...
  begin
    ...
    if ChBoxSpeñialChar.Checked and ChBoxSpeñialChar.Enabled then AStr := AStr + GetRandomChar(Special);
    if SpEditLength.Value = Length(AStr) then Break;
